...
*************************************************************************************** 
***************************************************************************************
**  author: yyyzrxh  date:2016-05-30
**
**  改进
**    1) 调整串口断开判断的语句顺序，弹出Warning窗口减少到两个
**    2)
**    3) 
** 
*/
...
#define WM_COMM_CLOSE_PORT      	WM_COMM_MSG_BASE + 10	//rxh2.8通知主线程，读数据发生错误，并关闭串口
...
///写数据到串口
	...
	static BOOL  Serial_port_remove;//rxh


protected:
	// protected memberfunctions
	void		ProcessErrorMessage(char* ErrorText);///错误处理
	static UINT CommThread(LPVOID pParam);///线程函数//rxh2.8 DWORD WINAPI改为了UINT
